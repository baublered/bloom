...
function RetailPayment() {
  ...
  const handleConfirmPayment = async () => {
    ...
    // --- FIX: Send the original orderSummary directly ---
    // The .map() function was removed because it was stripping necessary data.
    const transactionData = {
        transactionType: 'Retail',
        items: orderSummary, // This now sends the complete items, including bouquet data
        subtotal,
        discountAmount,
