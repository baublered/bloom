...
function RetailPayment() {
  ...
  useEffect(() => {
    if (paymentMethod === 'CASH') {
      ...
      // For other payment methods, amount paid is the total, and no change is needed
  ...
  const handleConfirmPayment = async () => {
    ...
    try {
      // --- UPDATED API CALL ---
      // This now correctly calls your new endpoint to create a transaction and update stock
