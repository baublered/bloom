...
function EventsPayment() {
  ...
  // Data passed from BillingEvents page, now including eventDetails
  const { 
      orderSummary = [], 
      eventDetails = {}, 
      grandTotal = 0, 
  ...
  const handleConfirmPayment = async () => {
    ...
    // --- UPDATED: Data now includes eventDetails ---
    const transactionData = {
        transactionType: 'Events', // Set the correct transaction type
        ...
        paymentMethod,
        eventDetails, // Include the specific details for this event
    };
    ...
    try {
      ...
      if (response.data.success) {
        ...
        // Navigate to receipt, passing all relevant data
        setTimeout(() => navigate('/receipt', { 
            state: { 
                ...location.state, // Pass all previous state
                paymentMethod, 
    ...
    <div className="payment-page-container">
      ...
      <main className="payment-main-content">
        ...
        <div className="payment-confirmation-box">
          ...
          {/* --- UPDATED: Shows event-specific info --- */}
          ...
          <div className="payment-details">
            <div className="mode-of-payment">
              ...
              <div className="payment-options-group">
                  <label><input type="radio" name="paymentMode" value="CASH" checked={paymentMethod === 'CASH'} onChange={(e) => setPaymentMethod(e.target.value)} /> CASH</label>
                  <label><input type="radio" name="paymentMode" value="GCASH" checked={paymentMethod === 'GCASH'} onChange={(e) => setPaymentMethod(e.target.value)} /> GCash</label>
                  <label><input type="radio" name="paymentMode" value="BANK" checked={paymentMethod === 'BANK'} onChange={(e) => setPaymentMethod(e.target.value)} /> Bank Transfer</label>
              </div>
            </div>
