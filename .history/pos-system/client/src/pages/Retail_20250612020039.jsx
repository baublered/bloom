  ...
  <div key={name} className="flower-item">
    <div className="flower-info">
      ...
      <div className="stock-info">
        <span>{quantity} available</span> {/* Display quantity below the product title */}
      </div>
      <span className="price-info">₱{price}</span> {/* Price with Peso sign */}
    </div>

    {/* Align checkbox and quantity controls side by side */}
    <div className="checkbox-and-quantity-container">
      ...
      {/* Quantity controls next to the checkbox */}
