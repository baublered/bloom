...
const Sidebar = () => (
    <div className="sidebar">
      ...
      <nav className="sidebar-nav">
        <a href="/dashboard">Dashboard</a><a href="/product-registration">Product Registration</a><a href="/user-registration">User Registration</a>
        <div className="nav-group active">
          <a href="/transactions" className="nav-group-title">Transactions</a>
          <div className="nav-submenu">
            <a href="/transactions/retail">Retail</a><a href="/transactions/events" className="active-link">Events</a>
          </div>
        </div>
        <a href="/reports">Reports</a><a href="/inventory">Inventory</a><a href="/maintenance">Maintenance</a>
      </nav>
      <div className="sidebar-footer"><span>?</span><span>&#x24D8;</span></div>
    </div>
);
const UserProfileHeader = () => (
    <header className="user-profile-header">
      <div className="user-profile-dropdown">
        <span className="user-icon">&#x1F464;</span><span>User Profile</span><span className="dropdown-arrow">▼</span>
      </div>
    </header>
);
