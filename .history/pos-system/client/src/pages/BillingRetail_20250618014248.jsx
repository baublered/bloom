...
function BillingRetail() {
  ...
  const getCartData = () => {
    // 1. Try to get data from navigation state (when coming from the retail page)
    ...
    // 2. Fallback to session storage (for page refreshes)
    ...
    // 3. Default to an empty state if no data is found
