...
import './Retail.css'; // New styles for the retail page
...
const Retail = () => {
  ...
  const addToCart = (product) => {
    setCart(prevCart => {
      ...
      if (existingItem) {
        // Increment quantity if item is already in cart, up to available stock
          ...
          {filteredProducts.map(product => (
            <div key={product._id} className="product-card" onClick={() => addToCart(product)}>
              ...
              <div className="product-card-info">
                ...
                <p className="product-card-stock">{product.quantity} in stock</p>
