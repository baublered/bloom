you know what, how about you base from my retail transaction. Because i think you were sending me the same program over and over and it's still not working. What i want is for you to show the available qty of products from my inventory and show it under my product title then the user can only add the number of products depending on the number of qty available in the inventory.

This is my retail.jsx
