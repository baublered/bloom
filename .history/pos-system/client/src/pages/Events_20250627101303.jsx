...
const Events = () => {
  ...
  const handleViewEventDetails = (event) => {
    if (event.status === 'Fully Paid') {
        ...
        // For cancelled events, you could show a message or do nothing
