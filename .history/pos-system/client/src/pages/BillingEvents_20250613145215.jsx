...
function BillingEvents() {
  ...
  // Retrieve the selected flowers passed from ProductSelection page
  const { selectedFlowers } = location.state || {};
    ...
    <div className="billing-events-container">
      ...
      <div className="billing-events-content">
        ...
        <div className="order-details">
          ...
          <p><strong>Customer Name:</strong> Alexine Maloping</p>
          <p><strong>Date:</strong> 10/26/2024</p>
          <p><strong>Events Address:</strong> 123 Maple Street, Antipolo, City</p>
          <p><strong>Phone Number:</strong> 09216854474</p>
          <p><strong>Products/Bundles Ordered:</strong> {selectedFlowers?.map(flower => flower.name).join(', ')}</p>
          <p><strong>Remarks:</strong> Yellow-themed wedding</p>
        </div>
