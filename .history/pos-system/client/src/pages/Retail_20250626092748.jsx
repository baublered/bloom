...
const Retail = () => {
  ...
  // --- NEW: State for managing active tab and bouquet creation ---
  const [activeTab, setActiveTab] = useState('Flowers'); // 'Flowers' or 'Bouquet'
  ...
  // --- NEW: Logic for building a bouquet ---
