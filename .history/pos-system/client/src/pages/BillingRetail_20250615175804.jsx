...
function BillingRetail() {
  ...
  // This new function prepares the data and navigates to RetailPayment.jsx
  const handleProceedToPayment = () => {
    ...
    const orderSummary = selectedFlowers.map(flower => ({
      ...
      addOns: flower.addOns || 'None' // Ensure addOns is handled even if missing
    }));

    // Navigate to the RetailPayment component, passing the collected data in state
    navigate('/RetailPayment', { 
      state: { 
        orderSummary,     // Detailed list of items
        discountAmount,   // Amount of discount applied
        grandTotal        // Final total after discount
      } 
    });
  };
  // >>> END OF MODIFICATION <<<
  ...
  return (
    <div className="billing-container">
      ...
      {/* >>> START OF MODIFICATION <<< */}
      {/* Changed the onClick handler to call the new handleProceedToPayment function */}
