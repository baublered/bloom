                    ...
                    <div key={index} className={`date-cell ${day ? 'clickable' : ''}`} onClick={(e) => handleDateClick(day, e)}>
                      ...
                      <div className="events-list">
                        {eventsForDay.map(event => (
                          <div key={event._id} className={`event-item ${getEventStatusClass(event.status)}`}>{event.customerName}</div>
                        ))}
                      </div>
                    </div>
                  );
        ...
        <div className="confirmation-modal-overlay">
            <div className="confirmation-modal cancel-confirmation">
                ...
                <div className="modal-actions">
                    <button className="modal-btn no" onClick={() => setIsCancelModalOpen(false)}>No</button>
                    <button className="modal-btn yes-cancel" onClick={confirmCancelEvent}>YES</button>
                </div>
            </div>
        </div>
      )}
