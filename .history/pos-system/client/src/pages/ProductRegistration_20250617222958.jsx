...
// Restoring the calendar imports
...
const ProductRegistration = () => {
  const [product, setProduct] = useState({
    ...
    quantity: '',
    supplierName: '',
    // Restoring the Date object for the calendar state
    dateReceived: new Date(), 
    lifespan: '',
  });

  // Restoring state for calendar and dropdown visibility
  ...
  // Restoring the handler for date changes
    ...
    <div className="product-registration-page">
      ...
      <div className="registration-card">
        ...
        <form onSubmit={handleSubmit} className="registration-form">
          ...
          <div className="form-row">
            {/* Restoring the custom date field with the pop-up calendar */}
