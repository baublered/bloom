...
function BillingRetail() {
  ...
  const handleProceedToPayment = () => {
    // Collect all the data you need to pass to RetailPayment.jsx
    const orderSummary = {
      selectedFlowers: selectedFlowers,
      discountAmount: parseFloat(discountAmount), // Ensure it's a number
      grandTotal: parseFloat(calculateGrandTotal()), // Ensure it's a number
      // You can add other details here if needed, like invoice ID, customer info, etc.
    };
