// import Calendar from 'react-calendar'; // --- REMOVED BROKEN IMPORT
// import 'react-calendar/dist/Calendar.css'; // --- REMOVED BROKEN IMPORT
import { Routes, useNavigate } from 'react-router-dom';
import './BillingRetail.css'; // Assuming this is the correct CSS file
                    ...
                    <main className="main-content">
                        <section className="order-details">
                            ...
                            <div className="details-grid">
                                ...
                                {/* --- REPLACED CALENDAR WITH A SIMPLE DIV --- */}
                                <div className="detail-item full-width">
                                    <label>Event Date</label>
                                    <div className="detail-value">October 26, 2024</div>
                                </div>
                                <div className="detail-item full-width">
