  ...
  const getCartData = () => {
    ...
    if (location.state?.cart) {
      return {
        ...
        // Ensure totalAmount is a number, defaulting to 0 if undefined
        totalAmount: typeof location.state.totalAmount === 'number' ? location.state.totalAmount : 0
      };
    }
    // Fallback to session storage for refresh-proofing
