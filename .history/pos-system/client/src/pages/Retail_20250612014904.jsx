 ...
 useEffect(() => {
  const fetchFlowers = async () => {
    try {
      ...
      console.log(response.data);  // Log the data to check if the stock field is available
  ...
  <div key={name} className="flower-item">
    <div className="flower-info">
      <div className="flower-title">
        ...
        <span className="stock-info">({stock} available)</span> {/* Display stock count as "12 available" */}
      </div>
