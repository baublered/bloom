...
const ProductRegistration = () => {
  ...
  const initialFormState = {
    ...
    lifespanInDays: '', // Changed from 'lifespan'
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // The backend now expects 'lifespanInDays'
      ...
      <div className="registration-card">
        ...
        <form onSubmit={handleSubmit} className="registration-form">
          ...
          <div className="form-row">
            ...
            {/* --- UPDATED: Input for lifespan in days --- */}
            <div className="input-group">
              <input type="number" name="lifespanInDays" placeholder="Lifespan (in days)" value={product.lifespanInDays} onChange={handleChange} className="registration-input" required />
            </div>
          </div>
