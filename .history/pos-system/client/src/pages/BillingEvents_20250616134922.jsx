...
import './BillingRetail.css'; // Import the new CSS file
...
function BillingEvents() {
    ...
    const eventDetails = {
        ...
        date: new Date('2024-10-26'), // Set to a specific date from your image
    ...
    const orderSummary = {
        ...
        totalAmount: 11490.00, // Corrected total based on P11500 - P10
    };
