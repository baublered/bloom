...
const Restock = () => {
    ...
    const handleSaveChanges = () => {
        // Filter out empty or zero values before checking
    ...
    // --- UPDATED: This now makes a real API call to the backend ---
    const confirmSaveChanges = async () => {
        try {
            ...
            const response = await axios.post('/api/products/restock', changesToSave);
