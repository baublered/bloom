...
const Inventory = () => {
  ...
  // This effect runs once to fetch data and generate notifications
  useEffect(() => {
      ...
      try {
        ...
        lowStockItems.forEach(item => {
          newNotifications.push({
            ...
            message: `SKU ${item._id.slice(-6).toUpperCase()} is running low.`,
            time: 'now'
          });
        });

        // 2. Generate Flower Recommendation
        // This is a placeholder. A real implementation might use an external API or a more complex backend logic.
      ...
      <div className="inventory-content">
        ...
        <div className="table-wrapper">
          <table className="inventory-table">
            <thead>
              <tr>
                <th>Product ID</th><th>Product Name</th><th>Category</th><th>Qty</th><th>Price</th><th>Supplier Name</th><th>Date Received</th><th>Remaining Lifespan</th>
              </tr>
            </thead>
            <tbody>
