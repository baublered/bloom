...
function RetailTransaction() {
  ...
  const flowers = flowerList.filter((product) => product.category === 'flowers');
  const addOns = flowerList.filter((product) => product.category === 'add-ons');
        ...
        <div className="retail-main">
          ...
          <div className="flower-list">
            ...
            <div className="flower-container">
              {flowers.map(({ name, price, quantity }) => (
