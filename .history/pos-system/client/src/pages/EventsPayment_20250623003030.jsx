...
const EventsPayment = () => {
    ...
    // Safely get data from the event billing page
    const { 
        orderSummary = [], // This is the selectedProducts array
        eventDetails = {}, 
        grandTotal = 0, 
        subtotal = 0, 
        discountAmount = 0 
    ...
    const handleConfirmPayment = async () => {
        ...
        // Prepare the data for the new "Events" transaction
        const transactionData = {
            ...
            paymentMethod,
            eventDetails, // Include the specific event details
        };

        try {
            // --- API CALL ---
            // This sends all the data to your unified transaction endpoint
            ...
            if (response.data.success) {
                ...
                // We don't need to clear session storage here as events are not stored there
                setTimeout(() => {
                    // Navigate to the receipt page with all necessary data
                    navigate('/receipt', { 
                        state: { 
                            orderSummary, 
                            eventDetails,
                            ...
                            discountAmount, 
                            paymentMethod,
                            amountPaid: grandTotal, // For non-cash, amount paid is the total
                            change: 0
                        }
                    });
                }, 2000);
