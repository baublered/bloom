...
function EventsPayment() {
  ...
  const handleConfirmPayment = async () => {
    ...
    const newPaymentData = {
        ...
        proofOfPayment: proofOfPayment?.name // Placeholder for now
    };
    ...
    const eventUpdateData = {
        ...
        subtotal,
        discountAmount,
        // We send the new payment object to be pushed into the paymentHistory array
        newPayment: newPaymentData
    };

    try {
      // We call the update endpoint
                         ...
                         <div className="payment-instructions">
                           <h4>Payment History</h4>
                            <div className="payment-history-list">
                                {eventDetails.paymentHistory && eventDetails.paymentHistory.length > 0 ? (
