  ...
  return (
    <aside className="sidebar">
      ...
      <nav className="sidebar-nav">
        {/* Links available to employees - everything except Reports, User Registration, Product Registration, and Maintenance */}
        ...
        <SidebarLink to="/employee-dashboard/inventory">Inventory</SidebarLink>
        
        {/* Help and About Us are available to all roles */}
        <SidebarLink to="/employee-dashboard/help">Help Center</SidebarLink>
        <SidebarLink to="/employee-dashboard/about">About Us</SidebarLink>
      </nav>
    </aside>
  );
}
